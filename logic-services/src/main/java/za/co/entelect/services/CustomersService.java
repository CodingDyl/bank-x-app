...
import za.co.entelect.entities.SearchType;
...
public class CustomersService {
    ...
    public Customers searchCustomers(CustomerSearchRequest searchRequest) {
        Map<SearchType, Supplier<Optional<Customers>>> searchStrategies = new HashMap<>();
        ...
        searchStrategies.put(SearchType.ACCOUNT_NUMBER_SEARCH, () -> customerRepository.findByAccountNumber(searchRequest.getAccountNumber()));
        searchStrategies.put(SearchType.IDENTIFICATION_SEARCH, () -> customerRepository.findByIdentificationNumber(searchRequest.getIdentification()));
